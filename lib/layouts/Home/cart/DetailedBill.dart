...
import 'package:navaclient/helpers/models/CartDetailsModel.dart';
import 'package:navaclient/layouts/Home/orders/SuccessfulOrder.dart';
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          text: cartDetailsModel.data.categoryTitle,
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          text: cartDetailsModel.data.street,
                                          style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),
                                        )
                                      ]
                                  )
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          text: cartDetailsModel.data.floor,
                                          style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),
                                        )
                                      ]
                                  )
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          text: cartDetailsModel.data.addressNotes,
                                          style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),
                                        )
                                      ]
                                  )
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                              shrinkWrap: true,
                              itemCount:
                              cartDetailsModel.data.services.length,
                             // orderDetailsModel.data!.services!.length,
                              ...
                              itemBuilder: (c, i) {
                                return serviceItem2(
                                  ...
                                  title: cartDetailsModel
                                      .data.services[i].title,
                                  price: cartDetailsModel
                                      .data.services[i].total
                                      .toString(),
                                );
                              }),
                        ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        cartDetailsModel
                            .data.services[index].services[i].price.toString(),
                        // price,
                        style: TextStyle(
